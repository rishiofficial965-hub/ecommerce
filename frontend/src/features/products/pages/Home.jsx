        ...
        <div className="container mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-drop-bounce">
            ...
            <p className="text-albescent-white/60 text-lg max-w-md mb-10 font-medium leading-relaxed">
              Discover the latest in streetwear. Bold designs, premium fabrics, and a fit that speaks for itself. 
              The Snitch drop is finally here.
            </p>
          ...
          <div className="hidden lg:flex justify-center relative">
            <div className="w-[450px] h-[550px] bg-desert-khaki/20 rounded-3xl border border-albescent-white/10 overflow-hidden relative group left-30">
              ...
              <div className="absolute bottom-10 left-10 z-20">
                <p className="text-albescent-white font-black text-2xl tracking-tight leading-none mb-2">Varsity Edit</p>
      ...
      <section className="py-24 container mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          ...
          <div className="flex gap-4">
            <button className="px-6 py-2 rounded-full border border-lacquered-licorice/10 font-bold hover:bg-lacquered-licorice hover:text-albescent-white transition-all">All</button>
            <button className="px-6 py-2 rounded-full border border-lacquered-licorice/10 font-bold hover:bg-lacquered-licorice hover:text-albescent-white transition-all">T-Shirts</button>
            <button className="px-6 py-2 rounded-full border border-lacquered-licorice/10 font-bold hover:bg-lacquered-licorice hover:text-albescent-white transition-all">Hoodies</button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-8 gap-y-16">
          {products.map((product) => (
            <div key={product._id} className="group cursor-pointer">
              <div className="relative aspect-[3/4] rounded-3xl overflow-hidden bg-desert-khaki/10 mb-6 group-hover:shadow-2xl transition-all duration-500 border border-lacquered-licorice/5">
                <img
                ...
                <div className="absolute top-4 right-4 flex flex-col gap-3 translate-x-12 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300 z-20">
                  <button className="w-10 h-10 bg-albescent-white rounded-full flex items-center justify-center text-lacquered-licorice hover:bg-copper-green hover:text-albescent-white transition-colors shadow-lg">
                    <FaRegHeart />
                  </button>
                  <button className="w-10 h-10 bg-albescent-white rounded-full flex items-center justify-center text-lacquered-licorice hover:bg-copper-green hover:text-albescent-white transition-colors shadow-lg">
                    <FaShoppingCart />
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 translate-y-full group-hover:translate-y-0 transition-transform duration-300 z-20">
                  <button className="w-full bg-lacquered-licorice text-albescent-white py-3 rounded-2xl font-black text-sm tracking-widest hover:bg-copper-green transition-colors">
                    QUICK ADD
                  </button>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-start">
                  <h3 className="font-black text-lg text-lacquered-licorice tracking-tight line-clamp-1 flex-1 uppercase">
                    {product.title}
                  </h3>
                  <span className="font-black text-copper-green">
                    {product.price.currency} {product.price.amount}
                  </span>
                </div>
                <p className="text-sm font-bold text-lacquered-licorice/30 uppercase tracking-widest">{product.category || "Lifestyle"}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="space-y-6">
              <h3 className="text-3xl font-black tracking-tighter uppercase italic">Snitch</h3>
            ...
            <div>
              <h4 className="font-black uppercase tracking-[0.2em] mb-8 text-sm text-playing-hooky">Shop</h4>
              <ul className="space-y-4 text-sm font-bold text-albescent-white/60">
                <li className="hover:text-albescent-white transition-colors cursor-pointer capitalize">All Products</li>
                <li className="hover:text-albescent-white transition-colors cursor-pointer capitalize">Best Sellers</li>
                <li className="hover:text-albescent-white transition-colors cursor-pointer capitalize">New Arrivals</li>
              </ul>
            </div>
            <div>
              <h4 className="font-black uppercase tracking-[0.2em] mb-8 text-sm text-playing-hooky">Support</h4>
              <ul className="space-y-4 text-sm font-bold text-albescent-white/60">
                <li className="hover:text-albescent-white transition-colors cursor-pointer capitalize">Help Center</li>
                <li className="hover:text-albescent-white transition-colors cursor-pointer capitalize">Shipping Policy</li>
                <li className="hover:text-albescent-white transition-colors cursor-pointer capitalize">Returns & Refunds</li>
              </ul>
            </div>
            <div>
              <h4 className="font-black uppercase tracking-[0.2em] mb-8 text-sm text-playing-hooky">Follow Us</h4>
